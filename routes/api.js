...
// produk
router.get("/produk", auth.authentication, auth.authorization, userAcces.accesUSer, redis.getProduk, apiController.getProduct);
router.get('/produk/:id', redis.getProduk, apiController.getProductid)
